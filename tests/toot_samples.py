...
toot_incorrectly_truncated = {'account':                {'acct':            'phildini',
                                                         'avatar':          'https://wandering.shop/system/accounts/avatars/000/000/001/original/e1068cb5c2779157.jpg',
                                                         'avatar_static':   'https://wandering.shop/system/accounts/avatars/000/000/001/original/e1068cb5c2779157.jpg',
                                                         'created_at':      datetime.datetime(2017, 4, 14, 18, 41, 53, 450000,
                                                                                              tzinfo=tzutc()),
                                                         'display_name':    'Phildini @ Home ✅',
                                                         'followers_count': 1023,
                                                         'following_count': 366,
                                                         'header':          'https://wandering.shop/system/accounts/headers/000/000/001/original/f3c768c5a3728380.jpg',
                                                         'header_static':   'https://wandering.shop/system/accounts/headers/000/000/001/original/f3c768c5a3728380.jpg',
                                                         'id':              1,
                                                         'locked':          False,
                                                         'note':            '<p>Wandering.shop admin. Writer of fiction, code, and '
                                                                            'campaigns.</p>',
                                                         'statuses_count':  3684,
                                                         'url':             'https://wandering.shop/@phildini',
                                                         'username':        'phildini'},
                              'application':            {'name': 'Amaroq', 'website': 'https://appsto.re/us/OfFxib.i'},
                              'content':                '<p>Has anyone written a story where the Amish play a crucial role '
                                                        'in future society because they deliberately choose which '
